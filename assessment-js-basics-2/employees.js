...
let empOne = new Employee("Chandler Bong", "friday morning, double saturday")
...
const empTwo = {...empOne, };
Object.assign(empTwo, {name: "Nick"});
...
const manager = new Manager("Prestin", "mon-fri", "jon and sal");
